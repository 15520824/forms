<?php
    function write_reporter_user_examinations_script(){
?>
<script type="text/javascript">
"use strict";

formTest.reporter_user_examinations.generateData = function(host) {
    var data, header;
    DOMElement.removeAllChildren(host.type_survey_container_container);
};

formTest.reporter_user_examinations.init = function(host, mode) {
    host.database = {};
    ...
    Promise.all(promiseAll).then(function() {
        ...
        switch (mode) {
            case 1:
                formTest.reporter_user_examinations_information.init(mainFrame.$viewport, host)
                break;
            case 2:
                break;
            case 3:
